        ...
        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr] items-center">
          <div>
            ...
            <RevealOnScroll delay={220}>
              <div className="mt-10 rounded-[32px] border-2 border-navy bg-bg p-6 shadow-neubrutal">
          ...
          <RevealOnScroll delay={180}>
            <div className="rounded-[32px] border-2 border-navy bg-bg p-8 shadow-neubrutal">
