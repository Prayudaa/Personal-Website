        ...
        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr] items-center">
          <div>
            ...
            <RevealOnScroll delay={220}>
              <div className="mt-10 rounded-[32px] border-2 border-navy-dark bg-glass-12 p-6 shadow-neubrutal transition-colors duration-200 hover:border-navy/70 hover:bg-glass-14">
          ...
          <RevealOnScroll delay={180}>
            <div className="rounded-[32px] border-2 border-navy-dark bg-glass-12 p-8 shadow-neubrutal transition-colors duration-200 hover:border-navy/70 hover:bg-glass-14">
