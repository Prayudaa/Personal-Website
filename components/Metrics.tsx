...
export default function Metrics() {
  return (
    <section className="py-16 md:py-24 section-shell bg-[rgba(255,255,255,0.04)]">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {METRICS.map((metric, index) => (
            <RevealOnScroll key={metric.label} delay={index * 100}>
              <div className="glass-card rounded-[26px] border border-white/10 bg-[rgba(255,255,255,0.06)] p-6 shadow-[0_24px_60px_rgba(0,0,0,0.18)] transition-transform duration-300 hover:-translate-y-1 hover:shadow-[0_30px_80px_rgba(0,0,0,0.22)]">
